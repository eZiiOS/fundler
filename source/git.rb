...
module Bundler
  class Source
    ...
    private
      ...
      streets_git_refresh_skip_and_revert_skip_for_local_editing_of_gems = ENV['EZII_RAILS']
      def fetch
        if ENV['EZII_RAILS'].to_s != '1'
          git_proxy.checkout
        end
      rescue GitError => e
        ...
        if ENV['EZII_RAILS']
          Bundler.ui.warn "streets_git_refresh_skip_and_revert_skip_for_local_editing_of_gems"
        end
      end
